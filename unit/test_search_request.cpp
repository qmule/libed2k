...
BOOST_AUTO_TEST_CASE(test_brackets)
{
    ...
    for(size_t n = 0; n < sizeof(bracket_expr)/sizeof(bracket_expr[0]); ++n)
    {
        ...
        BOOST_CHECK(sr[0].getOperator() == static_cast<libed2k::search_request_entry::SRE_Operation>(libed2k::search_request_entry::SRE_AND));
        BOOST_CHECK(sr[1].getOperator() == static_cast<libed2k::search_request_entry::SRE_Operation>(libed2k::search_request_entry::SRE_AND));
        BOOST_CHECK_EQUAL(sr[2].getStrValue(), std::string("a"));
        BOOST_CHECK_EQUAL(sr[3].getStrValue(), std::string("b"));
        BOOST_CHECK(sr[4].getOperator() == static_cast<libed2k::search_request_entry::SRE_Operation>(libed2k::search_request_entry::SRE_AND));
    ...
    BOOST_CHECK_THROW(libed2k::generateSearchRequest(0,0,0,0, "", "", "", 0, 0, "(( A)"), libed2k::libed2k_exception);
    BOOST_CHECK_THROW(libed2k::generateSearchRequest(0,0,0,0, "", "", "", 0, 0, "(((A))("), libed2k::libed2k_exception);
    BOOST_CHECK_THROW(libed2k::generateSearchRequest(0,0,0,0, "", "", "", 0, 0, "(A)AND"), libed2k::libed2k_exception);

    // check large expression
    libed2k::search_request sr = libed2k::generateSearchRequest(0,0,0,0,"", "", "", 0, 0, "a OR (b OR c AND d OR e) OR j (x OR (y z))");
    BOOST_REQUIRE_MESSAGE(sr.size() == 17U, "a OR (b OR c OR d OR e) OR j (x OR (y z))");

    BOOST_CHECK(sr[0].getOperator() == static_cast<libed2k::search_request_entry::SRE_Operation>(libed2k::search_request_entry::SRE_OR));
    BOOST_CHECK_EQUAL(sr[1].getStrValue(), std::string("a"));
    BOOST_CHECK(sr[2].getOperator() == static_cast<libed2k::search_request_entry::SRE_Operation>(libed2k::search_request_entry::SRE_OR));

    BOOST_CHECK(sr[3].getOperator() == static_cast<libed2k::search_request_entry::SRE_Operation>(libed2k::search_request_entry::SRE_OR));
    BOOST_CHECK_EQUAL(sr[4].getStrValue(), std::string("b"));

    BOOST_CHECK(sr[5].getOperator() == static_cast<libed2k::search_request_entry::SRE_Operation>(libed2k::search_request_entry::SRE_AND));
    BOOST_CHECK_EQUAL(sr[6].getStrValue(), std::string("c"));

    BOOST_CHECK(sr[7].getOperator() == static_cast<libed2k::search_request_entry::SRE_Operation>(libed2k::search_request_entry::SRE_OR));
    BOOST_CHECK_EQUAL(sr[8].getStrValue(), std::string("d"));
    BOOST_CHECK_EQUAL(sr[9].getStrValue(), std::string("e"));

    BOOST_CHECK(sr[10].getOperator() == static_cast<libed2k::search_request_entry::SRE_Operation>(libed2k::search_request_entry::SRE_AND));
    BOOST_CHECK_EQUAL(sr[11].getStrValue(), std::string("j"));

    BOOST_CHECK(sr[12].getOperator() == static_cast<libed2k::search_request_entry::SRE_Operation>(libed2k::search_request_entry::SRE_OR));
    BOOST_CHECK_EQUAL(sr[13].getStrValue(), std::string("x"));
    BOOST_CHECK(sr[14].getOperator() == static_cast<libed2k::search_request_entry::SRE_Operation>(libed2k::search_request_entry::SRE_AND));
    ...
    libed2k::search_request r5 = libed2k::generateSearchRequest(10,0,300,0, libed2k::ED2KFTSTR_CDIMAGE, "kad", "", 0, 0, "(X1 OR X2) and ");
    ...
    BOOST_CHECK(r5[8].getOperator() == static_cast<libed2k::search_request_entry::SRE_Operation>(libed2k::search_request_entry::SRE_AND));
    BOOST_CHECK(r5[9].getOperator() == static_cast<libed2k::search_request_entry::SRE_Operation>(libed2k::search_request_entry::SRE_OR));
...
BOOST_AUTO_TEST_CASE(test_search_build)
{
    ...
    BOOST_CHECK(r1[4].getOperator() == static_cast<libed2k::search_request_entry::SRE_Operation>(libed2k::search_request_entry::SRE_NOT));
    BOOST_CHECK_EQUAL(r1[5].getStrValue(), std::string("X3"));
    BOOST_CHECK(r1[6].getOperator() == static_cast<libed2k::search_request_entry::SRE_Operation>(libed2k::search_request_entry::SRE_OR));
    ...
    BOOST_CHECK(r3[0].getOperator() == static_cast<libed2k::search_request_entry::SRE_Operation>(libed2k::search_request_entry::SRE_AND));
    ...
    BOOST_CHECK(r3[4].getOperator() == static_cast<libed2k::search_request_entry::SRE_Operation>(libed2k::search_request_entry::SRE_AND));
    BOOST_CHECK_EQUAL(r3[5].getStrValue(), std::string("XDATA"));
    BOOST_CHECK(r3[6].getOperator() == static_cast<libed2k::search_request_entry::SRE_Operation>(libed2k::search_request_entry::SRE_NOT));
    ...
    BOOST_CHECK(r4[0].getOperator() == static_cast<libed2k::search_request_entry::SRE_Operation>(libed2k::search_request_entry::SRE_AND));
    ...
    BOOST_CHECK(r4[4].getOperator() == static_cast<libed2k::search_request_entry::SRE_Operation>(libed2k::search_request_entry::SRE_AND));
    BOOST_CHECK_EQUAL(r4[5].getInt32Value(), 1U);
    BOOST_CHECK(r4[6].getOperator() == static_cast<libed2k::search_request_entry::SRE_Operation>(libed2k::search_request_entry::SRE_OR));
    ...
    BOOST_CHECK(r5[10].getOperator() == static_cast<libed2k::search_request_entry::SRE_Operation>(libed2k::search_request_entry::SRE_OR));
    BOOST_CHECK_EQUAL(r5[11].getStrValue(), std::string("X1"));
    BOOST_CHECK(r5[12].getOperator() == static_cast<libed2k::search_request_entry::SRE_Operation>(libed2k::search_request_entry::SRE_AND));
...
{
    // simple search one string with logical expressions
    libed2k::search_request r1 =  libed2k::generateSearchRequest(0, 0, 0,0, libed2k::ED2KFTSTR_USER, "", "", 0, 0, "X1 X2");
    ...
    libed2k::search_request r2 =  libed2k::generateSearchRequest(0, 0, 0,0, libed2k::ED2KFTSTR_FOLDER, "", "", 0, 0, "X1");
    ...
    BOOST_CHECK_NO_THROW(libed2k::generateSearchRequest(40, 70, 20,0, libed2k::ED2KFTSTR_USER, "", "", 0, 0, "AND X1"));
}
