...
LIBED2K_EXPORT void SHA1_Init(SHA_CTX* context);
LIBED2K_EXPORT void SHA1_Update(SHA_CTX* context, u8 const* data, u32 len);
LIBED2K_EXPORT void SHA1_Final(u8* digest, SHA_CTX* context);
