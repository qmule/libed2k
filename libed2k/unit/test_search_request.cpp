...
BOOST_AUTO_TEST_CASE(test_search_build)
{
    ...
    libed2k::request_order r1 =  libed2k::generateSearchRequest(0, 0, 0, "", "", "X1 AND X2 AND X3 NOT X4 OR X5");
    ...
    libed2k::request_order r2 = libed2k::generateSearchRequest(0,0,0, "", "", "X1 \"AND\"");
    ...
    libed2k::request_order r3 = libed2k::generateSearchRequest(0,0,0, "", "", "X1  \"AND   \"  OR     XDATA  \"M\"M\"M\"   NOT   AAA");
    ...
    libed2k::request_order r4 = libed2k::generateSearchRequest(10,90,1, "", "", "X1 OR X2");
    ...
    libed2k::request_order r5 = libed2k::generateSearchRequest(10,9999000000000UL,300, libed2k::ED2KFTSTR_CDIMAGE, "kad", "X1 OR X2 and ");
